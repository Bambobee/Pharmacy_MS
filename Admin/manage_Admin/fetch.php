...
foreach ($result as $row) {
    $image = '';
    if ($row["image"] != '') {
        $image = '<img src="./Admin_images/' . $row["image"] . '" class="img-thumbnail" width="60" height="40" />';
    } else {
        $image = '<img src="./images/default-avatar.png" class="img-thumbnail" width="60" height="40" />';
    }
    $sub_array = array();
    $sub_array[] = $count;
    $sub_array[] = $image;
