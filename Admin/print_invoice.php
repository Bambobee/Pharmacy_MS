 ...
 foreach($result as $row)
 {
  ...
  foreach($item_result as $sub_row)
  {
   ...
   <tr>
    ...
    <td colspan="4">'.$sub_row["order_item_final_amount"].'</td>
   </tr>
   ';
  }
  $output .= '
  ...
  <tr>
   <td colspan="12"><b>Total Amt. Before Tax :</b></td>
   <td align="right">'.$row["order_total_before_tax"].'</td>
  </tr>
  <tr>
   <td colspan="12">Add : Tax1 :</td>
   <td align="right">'.$row["order_total_tax1"].'</td>
  </tr>
  <tr>
   <td colspan="12">Add : Tax2 :</td>
   <td align="right">'.$row["order_total_tax2"].'</td>
  </tr>
  <tr>
   <td colspan="12"><b>Total Tax Amt.  :</b></td>
   <td align="right">'.$row["order_total_tax"].'</td>
  </tr>
  <tr>
   <td colspan="12"><b>Total Amt. After Tax :</b></td>
