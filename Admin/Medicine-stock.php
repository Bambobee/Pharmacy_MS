                    ...
                    <div class="inner-box" id="card">
                        <div class="card-font">
                            <form method="post" id="customer_form" enctype="multiple/form-data">
                                ...
                                <label class="label">Enter the Quantity of Medicine stock</label>
                                <input type="number" name="quantity" id="quantity" class="input-box"
...
$(document).ready(function() {
    ...
    var dataTable = $('#example').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "manage_medicine_stock/fetch.php",
            type: "POST"
        },
        "columnDefs": [{
            "targets": [0, 5],
