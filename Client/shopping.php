        ...
        <main>
            <div class="rightbar close">
                ...
                <div class="contain1">
                  ...
                  ?>
                            <input style="color: var(--color-dark);" class="sendMessage" type="text" value="<?php echo $fetch['name']; ?>" >
                            <input type="hidden">
                ...
                <div class="container bg-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                      ...
                      <li><a class="nav-link" href="<?php echo SITEURL; ?>Cart.php"><i class="bx bx-shopping-bag"></i> 
...
<div id="message"></div>
<h2 class="start">FEATURED CATEGORIES</h2>
   <div class="combine">
   <?php
   $stmt = $conn->prepare("select * from tbl_category where featured='Yes' AND active='Yes' LIMIT 6;");
   $stmt->execute();
   ...
   <h2 class="start">New Arrivals</h2>
   <main class="all">
        <div class="slide-container">
            ...
            <section class="main" id="slider">
              <?php
                $stmt = $conn->prepare("SELECT * FROM tbl_medicine WHERE featured='yes' AND active='yes'");
                $stmt->execute();
                $result = $stmt->get_result();
                while($row = $result->fetch_assoc()) {
                    $image = '';
...
<!-- Modal Body -->
    ...
    <div class="modal fade" id="userModal">
        <div Style="baackground: #fff;" class="modal-dialog modal-dialog-centered modal-lg" role="document">
...
$(document).ready(function(){
 $(".addItemBtn").click(function(e){
    ...
    $.ajax({
        url: 'action.php',
        method: 'post',
        data: {pid:pid,pname:pname,uid:uid,pimage:pimage,pprice:pprice,pcode:pcode},
